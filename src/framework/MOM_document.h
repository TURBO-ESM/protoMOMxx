...
public:
  ...
  DocFileWriter(const std::string& doc_file_base,
                bool complete = true,
                bool minimal = true,
                bool layout = true,
                bool debugging = true);
  ...
  void doc_param(const std::string& varname, const std::string& desc,
  ...
  void doc_param(const std::string& varname, const std::string& desc,
                 ...
                 std::optional<std::int64_t> default_val = std::nullopt,
                 const DocParamOptions& opts = {});
  ...
  void doc_openBlock(const std::string& blockName,
...
private:
  ...
  bool mesg_has_been_documented(const std::string& varname,
