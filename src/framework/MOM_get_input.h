...
Directories get_directories(const std::filesystem::path &namelist_file = std::filesystem::path("input.nml"),
                            int ensemble_num = -1);
...
get_parameter_filenames(const std::filesystem::path &namelist_file = std::filesystem::path("input.nml"),
                        int ensemble_num = -1);
} // namespace MOM_get_input